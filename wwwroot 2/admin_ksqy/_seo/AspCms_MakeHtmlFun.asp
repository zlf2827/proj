...
'此处优化节省1.5秒以上
'by amysimple
googleStr =  "<?xml version=""1.0"" encoding=""UTF-8""?><urlset xmlns=""http://www.google.com/schemas/sitemap/0.84""><url><loc>http://"&setting.siteUrl&sitePath&setting.languagePath&"</loc></url>"
		for j=1 to rsObj.pagesize
