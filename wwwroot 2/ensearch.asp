...
Sub echoContent()
	...
	templatePath=sitePath&"/"&"templates/"&setting.defaultTemplate&"/"&setting.htmlFilePath&"/ensearch.html"	
	'die templatePath
	if not CheckTemplateFile(templatePath) then echo "ensearch.html"&err_16
